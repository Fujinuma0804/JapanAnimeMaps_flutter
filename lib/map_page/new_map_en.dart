...
class NewMapEn extends StatefulWidget {
  const NewMapEn(
      {Key? key, required double longitude, required double latitude})
      : super(key: key);

  @override
  State<NewMapEn> createState() => _NewMapEnState();
}

class _NewMapEnState extends State<NewMapEn> {
...
// ... [rest of the code remains the same]
  ...
  //以下、ver3.1.1へのアップデートに伴い、英語の地図ページのbottomnavigationのUI変更に伴い削除
