...
class ReportCommunityPage extends StatefulWidget {
  final String communityId;
  final String communityName;

  const ReportCommunityPage({
    Key? key,
  ...
  @override
  State<ReportCommunityPage> createState() => _ReportCommunityPageState();
}

class _ReportCommunityPageState extends State<ReportCommunityPage> {
