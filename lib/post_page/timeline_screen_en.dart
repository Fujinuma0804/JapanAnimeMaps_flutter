...
class TimelineScreenEn extends StatefulWidget {
  const TimelineScreenEn({Key? key}) : super(key: key);

  @override
  _TimelineScreenEnState createState() => _TimelineScreenEnState();
}

class _TimelineScreenEnState extends State<TimelineScreenEn>
              ...
              return const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                      'There are no posts\Make your first post！',
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Find a community'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
            ...
            ListTile(
              ...
              title: const Text('Participate with QR code'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Search for participating channels',
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, userCommunitiesSnapshot) {
                    if (userCommunitiesSnapshot.hasError) {
                      return ListTile(
                        title: Text(
                            'Error: ${userCommunitiesSnapshot.error}'),
                        subtitle: const Text('Failed to get community information'),
                      );
                    }
                    ...
                    if (communities.isEmpty) {
                      return const ListTile(
                        title: Text('There are no participating communities'),
                        subtitle: Text('Join our new community'),
                      );
                    }
                              ...
                              children: [
                                ...
                                Text(
                                  _searchQuery.isEmpty
                                      ...
                                      : '「$_searchQuery」No matching communities found',
                                  textAlign: TextAlign.center,
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                'There are no participating communities',
                                style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF00008b),
                              ...
                              const Text(
                                'Join the community and interact with everyone!',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: 14,
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Search for communities your a part of'),
                              ),
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                        ...
                        children: [
                          Container(
                            ...
                            child: TextField(
                              controller: _searchController,
                              decoration: InputDecoration(
                                hintText: 'Search for communities your a part of',
                                prefixIcon: const Icon(Icons.search,
                                    color: Color(0xFF00008b)),
                                suffixIcon: _searchQuery.isNotEmpty
                                    ? IconButton(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _searchQuery.isEmpty
                                              ? 'There are no active communities'
                                              : 'No communities found matching 「$_searchQuery」\n(You can search by community name, hashtag, or invitation code)',
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            color: Colors.grey,
                                            fontSize: 16,
...
// シェア用の画像を生成
  ...
  Future<void> _shareContent(BuildContext context) async {
    ...
    // シェアするコンテンツを構築
    shareContent.writeln('Posted by $userHandle');
    ...
    // シェアを実行
    await Share.share(shareContent.toString(), subject: 'Posted by $userHandle');
  }
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          'I reposted @${postData['originalUserHandle']} post',
                          style: const TextStyle(
                            color: Colors.grey,
                            fontSize: 12,
                          ),
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, repliesSnapshot) {
                    if (repliesSnapshot.hasError) {
                      return Center(
                        child: Text('Error: ${repliesSnapshot.error}'),
                      );
                    }
  ...
  Future<void> _submitReply() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('An error occurred while posting a reply: $e'),
