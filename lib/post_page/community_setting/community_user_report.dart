...
class CommunityReport extends StatefulWidget {
  ...
  @override
  State<CommunityReport> createState() => _CommunityReportState();
}

class _CommunityReportState extends State<CommunityReport> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('community_user_report').add({
          ...
          child: AlertDialog(
            ...
            content: Column(
              ...
              children: const [
                Text('ご協力ありがとうございます。'),
                SizedBox(height: 8),
                Text('確認事項があれば登録アドレスにご連絡させていただく可能性がございます。'),
              ],
            ),
            actions: [
              TextButton(
