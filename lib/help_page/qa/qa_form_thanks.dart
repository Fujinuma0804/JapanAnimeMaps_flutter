                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // お名前
                      if (inquiryData['name'] != null)
                        _buildInfoRow('お名前', inquiryData['name']),

                      // メールアドレス
                      if (inquiryData['email'] != null)
                        _buildInfoRow('メールアドレス', inquiryData['email']),

                      // ジャンル（存在する場合のみ表示）
                      if (inquiryData['genre'] != null)
                        _buildInfoRow('ジャンル', inquiryData['genre']),

                      // お電話番号（任意）
                      if (inquiryData['phone'] != null && inquiryData['phone'].toString().isNotEmpty)
                        _buildInfoRow('お電話番号', inquiryData['phone']),

                      // お問い合わせ内容
                      if (inquiryData['content'] != null)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text(
