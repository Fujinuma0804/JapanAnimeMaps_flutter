...
class AnimeListTestRankingEn extends StatefulWidget {
  @override
  _AnimeListTestRankingEnState createState() => _AnimeListTestRankingEnState();
}

class _AnimeListTestRankingEnState extends State<AnimeListTestRankingEn>
  ...
  int _compareNames(String a, String b) {
    ...
    if (a.startsWith('ん') && !b.startsWith('ん')) {
      return 1; // aがアルファベットの場合、後ろに
    } else if (!a.startsWith('ん') && b.startsWith('ん')) {
      return -1; // bがアルファベットの場合、後ろに
    } else if (a.startsWith('ん') && b.startsWith('ん')) {
      // 両方アルファベットの場合
      ...
      children: [
        if (_activeEvents.isNotEmpty)
          ExpansionTile(
            ...
            initiallyExpanded: _isEventsExpanded,
            onExpansionChanged: (expanded) {
              setState(() {
                _isEventsExpanded = expanded;
              });
            },
            children: [
              Container(
                height: 150, // イベントカードの高さを調整
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      width: 280, // カードの幅を広げる
                      margin: EdgeInsets.only(right: 16.0), // カード間のスペースを追加
