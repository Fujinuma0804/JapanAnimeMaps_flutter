...
class AnimeDetailsEngPage extends StatefulWidget {
  final String animeNameEn;

  AnimeDetailsEngPage({required this.animeNameEn});

  @override
  _AnimeDetailsEngPageState createState() => _AnimeDetailsEngPageState();
}

class _AnimeDetailsEngPageState extends State<AnimeDetailsEngPage> {
  ...
  Future<DocumentSnapshot> _fetchAnimeData() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          .collection('animes')
          .where('nameEn', isEqualTo: widget.animeNameEn)
          .get();
  ...
  Future<List<Map<String, dynamic>>> _fetchLocationsForAnime() async {
    ...
    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          ...
          .where('animeNameEn', isEqualTo: widget.animeNameEn)
          .get();
            ...
            children: [
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text(
                    userId.isNotEmpty ? 'Posted by: @$userId' : 'Error',
                    style: TextStyle(
                      fontSize: 10,
                      color: Colors.grey,
                    ),
                ...
                child: FutureBuilder<List<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.isEmpty) {
                      return Center(
                          child: Text(
                              'No locations found for ${widget.animeNameEn}.'));
                    }
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => SpotDetailEnScreen(
              ...
              animeNameEn: widget.animeNameEn,
            ),
          ),
        );
      },
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 4.0),
            Text(
              titleEn.isNotEmpty ? titleEn : 'Error',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14.0,
                fontWeight: FontWeight.bold,
            ...
            Text(
              userId.isNotEmpty ? 'Posted by: @$userId' : 'Posted by: Unknown',
              style: TextStyle(
                fontSize: 12.0,
                color: Colors.grey,
              ),
...
Click here for a wonderful pilgrimage：
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      'Appearance scene in『${widget.animeNameEn}』',
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
