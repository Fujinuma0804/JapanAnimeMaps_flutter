...
class ImportantNoticesTab extends StatefulWidget {
  const ImportantNoticesTab({Key? key}) : super(key: key);

  @override
  _ImportantNoticesTabState createState() => _ImportantNoticesTabState();
}

class _ImportantNoticesTabState extends State<ImportantNoticesTab> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
          ...
          .where('priority', whereIn: ['Critical', 'Important']).snapshots(),
