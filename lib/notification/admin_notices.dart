...
class AdminNoticesTab extends StatefulWidget {
  const AdminNoticesTab({Key? key}) : super(key: key);

  @override
  _AdminNoticesTabState createState() => _AdminNoticesTabState();
}

class _AdminNoticesTabState extends State<AdminNoticesTab> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
          ...
          .where('priority', whereIn: ['Normal']).snapshots(),
